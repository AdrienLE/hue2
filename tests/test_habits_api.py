...
class TestSubHabitEndpoints:
    ...
    def test_get_sub_habits(self, mock_auth, mock_db):
        ...
        # Mock sub-habits
        mock_sub_habits = [
            SubHabit(id=1, parent_habit_id=1, user_id="test-user-123", name="Sub-habit 1", order_index=0),
            SubHabit(id=2, parent_habit_id=1, user_id="test-user-123", name="Sub-habit 2", order_index=1),
        ]
...
class TestCheckEndpoints:
    ...
    def test_get_checks(self, mock_auth, mock_db):
        mock_checks = [
            Check(id=1, user_id="test-user-123", habit_id=1, checked=True, check_date=datetime.utcnow()),
            Check(id=2, user_id="test-user-123", habit_id=1, checked=False, check_date=datetime.utcnow()),
        ]
...
class TestCountEndpoints:
    ...
    def test_get_counts(self, mock_auth, mock_db):
        mock_counts = [
            Count(id=1, user_id="test-user-123", habit_id=1, value=25, count_date=datetime.utcnow()),
            Count(id=2, user_id="test-user-123", habit_id=1, value=30, count_date=datetime.utcnow()),
        ]
...
class TestWeightUpdateEndpoints:
    ...
    def test_get_weight_updates(self, mock_auth, mock_db):
        mock_updates = [
            WeightUpdate(id=1, user_id="test-user-123", habit_id=1, weight=70.5, update_date=datetime.utcnow()),
            WeightUpdate(id=2, user_id="test-user-123", habit_id=1, weight=69.8, update_date=datetime.utcnow()),
        ]
...
class TestActiveDayEndpoints:
    ...
    def test_get_active_days(self, mock_auth, mock_db):
        mock_days = [
            ...
            ActiveDay(id=2, user_id="test-user-123", date=datetime.utcnow() - timedelta(days=1), validated=False),
        ]
