...
type AuthProviderName = 'auth0' | 'firebase' | 'supabase' | 'custom';
type NotificationProviderName = 'expo' | 'firebase' | 'onesignal' | 'none';
type UploadStorageProviderName = 'railway-bucket' | 's3' | 'local' | 'none';
...
export const SERVICE_CONFIG = {
  ...
  storage_uploads: {
    provider: 'railway-bucket' as UploadStorageProviderName,
